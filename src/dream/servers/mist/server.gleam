...
pub fn new() -> dream.Dream(mist.Builder(Connection, ResponseData)) {
  dream.Dream(
...
pub fn router(
  dream_instance: dream.Dream(mist.Builder(Connection, ResponseData)),
  router: Router,
) -> dream.Dream(mist.Builder(Connection, ResponseData)) {
  dream.Dream(
    ..dream_instance,
    router: router,
    server: mist.new(handler.create(router, dream_instance.max_body_size)),
  )
}
...
pub fn max_body_size(
  ...
  dream.Dream(
    ..dream_instance,
    max_body_size: size,
    server: mist.new(handler.create(dream_instance.router, size)),
  )
}
